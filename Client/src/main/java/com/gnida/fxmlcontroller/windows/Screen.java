package com.gnida.fxmlcontroller.windows;

public class Screen {
    public static final String AUTHORIZE = "/fxml/authorize-view.fxml";
    public static final String HOME_ADMIN = "/fxml/admin/home-admin-view.fxml";
    public static final String HOME_USER = "/fxml/user/home-user-view.fxml";

    public static final String BUDGETS_ALL = "/fxml/admin/budgets-all-view.fxml";
